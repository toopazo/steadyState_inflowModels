function ...
    [T_u, Q_u, P_u, lambda_u, T_l, Q_l, P_l, lambda_l] = ...
        bet_coax_downwash(blade_type, lambda_c, mu, omega_u, omega_l)
    
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    blade_u_st = blade_model(blade_type, lambda_c, mu, false);
    blade_u_st.position             = 'upper';
    blade_u_st.lambda_u_downwash    = NaN;
    ...
    lambda_u_downwash   = 2 * bet_u_st.total.lambda;      

    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    blade_l_st = blade_model(blade_type, lambda_c, mu, false);
    blade_l_st.position             = 'lower';
    blade_l_st.lambda_u_downwash    = lambda_u_downwash; 
    ...
    lambda_l_downwash   = 2 * bet_l_st.total.lambda;   
